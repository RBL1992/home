...
washingMachineSchema.virtual('nextMaintenanceDate').get(function () {
  return dayjs(this.lastMaintenanceDate).add(30, 'day').format('MM/DD/YYYY');
});

module.exports = washingMachineSchema;
