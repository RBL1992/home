...
const EditModal = (props) => {
    ...
    const dropdownOption = (featureItem) => {
        if(featureItem.__typename >= "Hvac") {
            return `HVAC`;
        } else {return featureItem.__typename;}
    };
        ...
        return (
            <div className="flex flex-row-reverse">
                <button
                    ...
                    <img className="min-w-min h-5 w-5 flex-shrink-0 " src={editIcon} alt="" />
                </button>
                                            ...
                                            <div className="mt-3 text-center sm:mt-5">
                                                ...
                                                <div className="mt-2">
                                                    <form
                                                        ...
                                                        data-id={props.feature._id} className="space-y-6" action="#" method="PUT" onSubmit={handleFormSubmit}>
                                                        <label htmlFor="featureCategory">Feature</label>
                                                        <select id="featureCategory" name="featureCategory" onChange={handleChange}>
                                                            <option selected disabled>{dropdownOption(props.feature)}</option>
                                                        ...
                                                        <input type="text" id="featureName" name='itemCategory' value={feature.itemCategory} onChange={handleChange} required /><br />

                                                        <label htmlFor="room">Room:</label>
                                                        <input type="text" id="room" name='room' value={feature.room} onChange={handleChange} required /><br />

                                                        <label htmlFor="maintenanceDate">Last Maintenance Date:</label>
                                                        <input type="date" id="maintenance" name='lastMaintenanceDate' value={dayjs(feature.lastMaintenanceDate).format("YYYY-MM-DD")} onChange={handleChange} required /><br />

                                                        <label htmlFor="brandName">Brand Name:</label>
                                                        <input type="text" id="brandName" name="brandName" value={feature.brandName} onChange={handleChange} required /><br />
