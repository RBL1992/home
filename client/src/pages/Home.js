...
const Home = () => {
  ...
  const { loading, data, error } = useQuery(QUERY_ME, {
    onCompleted: ({ me: { filter, gutter, alarm, hvac, doorbell, outlet, ceilingfan, exhaustfan } }) => setFeatureList([...filter, ...gutter, ...alarm, ...hvac, ...doorbell, ...outlet, ...ceilingfan, ...exhaustfan]),
  });
